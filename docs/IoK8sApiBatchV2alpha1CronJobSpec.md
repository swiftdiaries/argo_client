...
**job_template** | [**IoK8sApiBatchV2alpha1JobTemplateSpec**](IoK8sApiBatchV2alpha1JobTemplateSpec.md) | Specifies the job that will be created when executing a CronJob. | 
