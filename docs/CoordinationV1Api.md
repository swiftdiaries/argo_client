...
> IoK8sApiCoordinationV1Lease create_coordination_v1_namespaced_lease(namespace, body, pretty=pretty, dry_run=dry_run, field_manager=field_manager)
...
api_instance = argo_client.CoordinationV1Api(argo_client.ApiClient(configuration))
namespace = 'namespace_example' # str | object name and auth scope, such as for teams and projects
body = argo_client.IoK8sApiCoordinationV1Lease() # IoK8sApiCoordinationV1Lease | 
...
try:
    api_response = api_instance.create_coordination_v1_namespaced_lease(namespace, body, pretty=pretty, dry_run=dry_run, field_manager=field_manager)
    pprint(api_response)
...
> IoK8sApimachineryPkgApisMetaV1Status delete_coordination_v1_collection_namespaced_lease(namespace, pretty=pretty, allow_watch_bookmarks=allow_watch_bookmarks, _continue=_continue, field_selector=field_selector, label_selector=label_selector, limit=limit, resource_version=resource_version, timeout_seconds=timeout_seconds, watch=watch)
...
try:
    api_response = api_instance.list_coordination_v1_lease_for_all_namespaces(allow_watch_bookmarks=allow_watch_bookmarks, _continue=_continue, field_selector=field_selector, label_selector=label_selector, limit=limit, pretty=pretty, resource_version=resource_version, timeout_seconds=timeout_seconds, watch=watch)
    pprint(api_response)
except ApiException as e:
...
> IoK8sApiCoordinationV1Lease patch_coordination_v1_namespaced_lease(name, namespace, body, pretty=pretty, dry_run=dry_run, field_manager=field_manager, force=force)
...
try:
    api_response = api_instance.patch_coordination_v1_namespaced_lease(name, namespace, body, pretty=pretty, dry_run=dry_run, field_manager=field_manager, force=force)
    pprint(api_response)
except ApiException as e:
...
> IoK8sApiCoordinationV1Lease replace_coordination_v1_namespaced_lease(name, namespace, body, pretty=pretty, dry_run=dry_run, field_manager=field_manager)
...
try:
    api_response = api_instance.replace_coordination_v1_namespaced_lease(name, namespace, body, pretty=pretty, dry_run=dry_run, field_manager=field_manager)
    pprint(api_response)
except ApiException as e:
