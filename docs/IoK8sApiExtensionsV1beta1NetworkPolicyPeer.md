...
------------ | ------------- | ------------- | -------------
**ip_block** | [**IoK8sApiExtensionsV1beta1IPBlock**](IoK8sApiExtensionsV1beta1IPBlock.md) | IPBlock defines policy on a particular IPBlock. If this field is set then neither of the other fields can be. | [optional] 
