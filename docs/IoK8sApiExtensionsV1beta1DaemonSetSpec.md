...
**update_strategy** | [**IoK8sApiExtensionsV1beta1DaemonSetUpdateStrategy**](IoK8sApiExtensionsV1beta1DaemonSetUpdateStrategy.md) | An update strategy to replace existing DaemonSet pods with new pods. | [optional] 
