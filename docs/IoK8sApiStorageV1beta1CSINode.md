...
**metadata** | [**IoK8sApimachineryPkgApisMetaV1ObjectMeta**](IoK8sApimachineryPkgApisMetaV1ObjectMeta.md) | metadata.name must be the Kubernetes node name. | [optional] 
**spec** | [**IoK8sApiStorageV1beta1CSINodeSpec**](IoK8sApiStorageV1beta1CSINodeSpec.md) | spec is the specification of CSINode | 
