...
**spec** | [**IoK8sApiNetworkingV1NetworkPolicySpec**](IoK8sApiNetworkingV1NetworkPolicySpec.md) | Specification of the desired behavior for this NetworkPolicy. | [optional] 
