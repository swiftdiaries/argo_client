...
**spec** | [**IoK8sApiAuthorizationV1beta1SubjectAccessReviewSpec**](IoK8sApiAuthorizationV1beta1SubjectAccessReviewSpec.md) | Spec holds information about the request being evaluated.  spec.namespace must be equal to the namespace you made the request against.  If empty, it is defaulted. | 
