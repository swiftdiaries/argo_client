...
**role_ref** | [**IoK8sApiRbacV1alpha1RoleRef**](IoK8sApiRbacV1alpha1RoleRef.md) | RoleRef can only reference a ClusterRole in the global namespace. If the RoleRef cannot be resolved, the Authorizer must return an error. | 
