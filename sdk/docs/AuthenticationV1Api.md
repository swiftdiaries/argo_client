...
api_instance = argo.sdk.AuthenticationV1Api(argo.sdk.ApiClient(configuration))
body = argo.sdk.IoK8sApiAuthenticationV1TokenReview() # IoK8sApiAuthenticationV1TokenReview | 
