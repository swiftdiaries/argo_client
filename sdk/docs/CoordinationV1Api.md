...
api_instance = argo.sdk.CoordinationV1Api(argo.sdk.ApiClient(configuration))
body = argo.sdk.IoK8sApiCoordinationV1Lease() # IoK8sApiCoordinationV1Lease | 
