...
api_instance = argo.sdk.SchedulingV1Api(argo.sdk.ApiClient(configuration))
body = argo.sdk.IoK8sApiSchedulingV1PriorityClass() # IoK8sApiSchedulingV1PriorityClass | 
