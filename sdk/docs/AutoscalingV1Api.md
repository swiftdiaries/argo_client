...
api_instance = argo.sdk.AutoscalingV1Api(argo.sdk.ApiClient(configuration))
body = argo.sdk.IoK8sApiAutoscalingV1HorizontalPodAutoscaler() # IoK8sApiAutoscalingV1HorizontalPodAutoscaler | 
