...
api_instance = argo.sdk.BatchV2alpha1Api(argo.sdk.ApiClient(configuration))
body = argo.sdk.IoK8sApiBatchV2alpha1CronJob() # IoK8sApiBatchV2alpha1CronJob | 
