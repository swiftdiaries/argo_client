...
import argo_client
from argo_client.api.authorization_v1beta1_api import AuthorizationV1beta1Api  # noqa: E501
...
class TestAuthorizationV1beta1Api(unittest.TestCase):
    ...
    def setUp(self):
        self.api = argo_client.api.authorization_v1beta1_api.AuthorizationV1beta1Api()  # noqa: E501
