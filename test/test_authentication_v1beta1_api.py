...
import argo_client
from argo_client.api.authentication_v1beta1_api import AuthenticationV1beta1Api  # noqa: E501
...
class TestAuthenticationV1beta1Api(unittest.TestCase):
    ...
    def setUp(self):
        self.api = argo_client.api.authentication_v1beta1_api.AuthenticationV1beta1Api()  # noqa: E501
