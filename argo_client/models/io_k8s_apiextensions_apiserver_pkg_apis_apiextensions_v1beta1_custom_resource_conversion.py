...
from argo_client.models.io_k8s_apiextensions_apiserver_pkg_apis_apiextensions_v1beta1_webhook_client_config import IoK8sApiextensionsApiserverPkgApisApiextensionsV1beta1WebhookClientConfig  # noqa: F401,E501
...
class IoK8sApiextensionsApiserverPkgApisApiextensionsV1beta1CustomResourceConversion(object):
    ...
    def webhook_client_config(self):
        ...
        `webhookClientConfig` is the instructions for how to call the webhook if strategy is `Webhook`. This field is alpha-level and is only honored by servers that enable the CustomResourceWebhookConversion feature.  # noqa: E501
